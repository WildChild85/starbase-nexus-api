...
namespace starbase_nexus_api.Migrations
{
    ...
    [Migration("20211009201525_SplitKeyIntoPositionAndSizeInShipShopSpot")]
    partial class SplitKeyIntoPositionAndSizeInShipShopSpot
    {
            ...
            modelBuilder.Entity("starbase_nexus_api.Entities.Constructions.Ship", b =>
                {
                    ...
                    b.Property<Guid?>("ShipShopSpotId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("starbase_nexus_api.Entities.Constructions.Ship", b =>
                {
                    ...
                    b.HasOne("starbase_nexus_api.Entities.InGame.ShipShopSpot", "ShipShopSpot")
                        .WithMany()
                        .HasForeignKey("ShipShopSpotId")
                        .OnDelete(DeleteBehavior.Restrict);
